...
export default function AdoptModal({
  ...
  const handleNameChange = (val: string) => {
    ...
    let cleaned =
      onlyLettersAndSpaces.replace(/ +/g, ' ');
    ...
    if (!isNameValid) {
      setFormError(
        lang === 'EN'
          ...
          : 'कृपया मान्य पूरा नाम दर्ज करें'
      );
      return;
    }
    ...
    if (!stateName.trim()) {
      setFormError(
        lang === 'EN'
          ...
          : 'कृपया अपना राज्य / प्रांत चुनें या दर्ज करें'
      );
      return;
    }
    ...
    try {
      ...
      setFormError(
        lang === 'EN'
          ...
          : lang === 'HI'
            ? 'आपकी पूछताछ जमा नहीं हो सकी। कृपया पुनः प्रयास करें।'
            : lang === 'KN'
              ? 'ನಿಮ್ಮ ವಿಚಾರಣೆಯನ್ನು ಸಲ್ಲಿಸಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.'
              : 'तुमची चौकशी सबमिट करता आली नाही. कृपया पुन्हा प्रयत्न करा.'
      );
    } finally {
    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="w-full max-w-lg mx-auto p-4 sm:p-6">
          ...
          <div className="relative w-full overflow-hidden rounded-3xl bg-white dark:bg-slate-900 shadow-2xl border border-gray-100 dark:border-slate-800">
                ...
                >
                  ...
                  <h4 className="text-lg font-sans font-extrabold text-gray-900 dark:text-white leading-tight">
                    {lang === 'EN'
                      ...
                      : lang === 'HI'
                        ? 'दत्तक ग्रहण के बारे में जानकारी प्राप्त करें'
                        : lang === 'KN'
                          ? 'ದತ್ತು ಪ್ರಕ್ರಿಯೆಯ ಬಗ್ಗೆ ಮಾಹಿತಿ ಪಡೆಯಿರಿ'
                          : 'दत्तक प्रक्रियेबद्दल माहिती मिळवा'}
                  </h4>
                  ...
                  <div className="p-4 bg-yellow-50 dark:bg-yellow-950/20 rounded-xl border border-yellow-200 dark:border-yellow-900/50 flex gap-3 items-start shadow-sm">
                    ...
                    <div className="text-xs text-yellow-900 dark:text-yellow-200 leading-relaxed font-medium space-y-2">
                      ...
                      <p className="font-semibold text-yellow-950 dark:text-yellow-100">
                        {lang === 'EN'
                          ? 'All adoption procedures are governed strictly by the guidelines of the Central Adoption Resource Authority (CARA), Government of India.'
                          : lang === 'HI'
                            ? 'सभी दत्तक ग्रहण प्रक्रियाएं केंद्रीय दत्तक ग्रहण संसाधन प्राधिकरण (CARA), भारत सरकार के दिशानिर्देशों द्वारा कड़ाई से शासित होती हैं।'
                            : lang === 'KN'
                              ? 'ಎಲ್ಲಾ ದತ್ತು ಪ್ರಕ್ರಿಯೆಗಳನ್ನು ಭಾರತ ಸರ್ಕಾರದ ಕೇಂದ್ರ ದತ್ತು ಸಂಪನ್ಮೂಲ ಪ್ರಾಧಿಕಾರ (CARA) ಮಾರ್ಗಸೂಚಿಗಳ ಅಡಿಯಲ್ಲಿ ಕಟ್ಟುನಿಟ್ಟಾಗಿ ನಿಯಂತ್ರಿಸಲಾಗುತ್ತದೆ.'
                      ...
                      <p>
                        {lang === 'EN'
                          ? 'Swami Vivekanand Seva Pratishthan (SVSP) does not select, allocate, or match children with prospective adoptive parents. All child-parent matching is carried out exclusively through the CARA centralized system and in accordance with applicable laws and regulations.'
                          : lang === 'HI'
                            ? 'स्वामी विवेकानंद सेवा प्रतिष्ठान (SVSP) भावी दत्तक माता-पिता के साथ बच्चों का चयन, आवंटन या मिलान नहीं करता है। सभी बच्चे-माता-पिता का मिलान विशेष रूप से CARA केंद्रीकृत प्रणाली के माध्यम से और लागू कानूनों और विनियमों के अनुसार किया जाता है।'
                            : lang === 'KN'
                              ? 'ಸ್ವಾಮಿ ವಿವೇಕಾನಂದ ಸೇವಾ ಪ್ರತಿಷ್ಠಾನವು (SVSP) ಮಕ್ಕಳನ್ನು ಆಯ್ಕೆ ಮಾಡುವುದಿಲ್ಲ ಅಥವಾ ದತ್ತು ಪಡೆಯುವ ಪೋಷಕರೊಂದಿಗೆ ಹೊಂದಿಸುವುದಿಲ್ಲ. ಎಲ್ಲಾ ಮಕ್ಕಳ ಹಾಗೂ ಪೋಷಕರ ಹೊಂದಾಣಿಕೆಯನ್ನು ಕೇವಲ CARA ಕೇಂದ್ರೀಕೃತ ವ್ಯವಸ್ಥೆಯ ಮೂಲಕ ನಿಯಮಾನುಸಾರ ಮಾಡಲಾಗುತ್ತದೆ.'
                      ...
                      <p>
                        {lang === 'EN'
                          ? 'Please refer to the official CARA guidelines before proceeding with any adoption-related inquiry.'
                          : lang === 'HI'
                            ? 'कृपया दत्तक ग्रहण से संबंधित किसी भी पूछताछ के साथ आगे बढ़ने से पहले आधिकारिक CARA दिशानिर्देशों का संदर्भ लें।'
                            : lang === 'KN'
                              ? 'ದತ್ತು ಪ್ರಕ್ರಿಯೆಗೆ ಸಂಬಂಧಿಸಿದ ಯಾವುದೇ ವಿಚಾರಣೆಯೊಂದಿಗೆ ಮುಂದುವರಿಯುವ ಮೊದಲು ದಯವಿಟ್ಟು ಅಧಿಕೃತ CARA ಮಾರ್ಗಸೂಚಿಗಳನ್ನು ನೋಡಿ.'
                  ...
                  <div className="pb-2">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 text-xs font-bold text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 underline"
                    >
                      <FileText size={16} />

                      <span>
                        {lang === 'EN'
                          ? 'Download CARA Adoption Guidelines PDF'
                          : lang === 'HI'
                            ? 'कारा दत्तक ग्रहण नियमावली PDF डाउनलोड करें'
                            : lang === 'KN'
                              ? 'CARA ದತ್ತು ಮಾರ್ಗಸೂಚಿಗಳ PDF ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ'
                              : 'CARA दत्तक मार्गदर्शक तत्वे PDF डाउनलोड करा'}
                      </span>
                    </a>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <label
                          htmlFor="adopt-name"
                          className="block text-xs font-semibold text-gray-600 dark:text-slate-300"
                        >
                          {t('adopt_full_name')} *
                        </label>
                      ...
                      <input
                        ...
                        } rounded-lg py-2.5 px-3 text-sm focus:outline-none focus:ring-1 focus:ring-amber-500 text-gray-800 dark:text-slate-100`}
                      />
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder={
                          lang === 'EN'
                            ? 'Enter your inquiries regarding CARA guidelines, eligibility, registration, etc.'
                            : lang === 'HI'
                              ? 'कारा दिशानिर्देशों, पात्रता, पंजीकरण आदि के बारे में अपनी पूछताछ दर्ज करें।'
                              : lang === 'KN'
                                ? 'CARA ಮಾರ್ಗಸೂಚಿಗಳು, ಅರ್ಹತೆ, ನೋಂದಣಿ ಇತ್ಯಾದಿಗಳ ಬಗ್ಗೆ ನಿಮ್ಮ ವಿಚಾರಣೆಗಳನ್ನು ನಮೂದಿಸಿ.'
                                : 'CARA मार्गदर्शक तत्त्वे, पात्रता, नोंदणी इत्यादींबद्दलच्या तुमच्या चौकशीची नोंद करा.'
                        }
                        className="w-full bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg py-2.5 px-3 text-sm focus:outline-none focus:ring-1 focus:ring-amber-500 text-gray-800 dark:text-slate-100"
                      />
                  ...
                  {formError && (
                    <div
                      role="alert"
                      className="bg-red-500/10 border border-red-500/20 text-red-500 text-xs font-semibold p-3 rounded-xl font-mono"
                    >
                      {formError}
                    </div>
                  )}
                  ...
                  <p className="text-[10px] text-gray-400 leading-normal text-center">
                    {lang === 'EN'
                      ? 'Adoption from our specialized homes is fully regulated under the Ministry of Women and Child Development (CARA guidelines). No charge applies for pre-screening inquiries.'
                      : lang === 'HI'
                        ? 'हमारे विशिष्ट गृहों से दत्तक ग्रहण पूरी तरह से महिला एवं बाल विकास मंत्रालय (कारा दिशानिर्देश) के तहत विनियमित है। पूछताछ के लिए कोई शुल्क नहीं है।'
                        : lang === 'KN'
                          ? 'ನಮ್ಮ ಗೃಹಗಳಿಂದ ದತ್ತು ಪ್ರಕ್ರಿಯೆಯು ಮಹಿಳಾ ಮತ್ತು ಮಕ್ಕಳ ಅಭಿವೃದ್ಧಿ ಸಚಿವಾಲಯದ (CARA) ಅಡಿಯಲ್ಲಿ ನಿಯಂತ್ರಿಸಲ್ಪಡುತ್ತದೆ.'
                      ...
                      <BouncingDots
                        ...
                        message={
                          lang === 'EN'
                            ...
                            : lang === 'HI'
                              ? 'दिशा-निर्देशों का सत्यापन...'
                              : lang === 'KN'
                                ? 'ಮಾರ್ಗಸೂಚಿಗಳ ಪರಿಶೀಲನೆ...'
                                : 'मार्गदर्शक तत्त्वांचे सत्यापन...'
                        }
                      />
                    ) : (
                      <span>

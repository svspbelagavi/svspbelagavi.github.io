...
if (!SCRIPT_URL) {
  console.error('[ContactSection] VITE_SCRIPT_URL is not set. Contact form will not work.');
}
...
>
  ...
  setFormData((prev) => ({
    ...
    name: cleanName(e.target.value),
                    ...
                    />
                    {nameError && (
                      <span role="alert" aria-live="polite" className="block text-[10px] font-bold text-red-500 font-mono mt-1 pl-1">
                        {nameError}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      />
                      {emailError && (
                        <span role="alert" aria-live="polite" className="block text-[10px] font-bold text-red-500 font-mono mt-1">{emailError}</span>
                      )}
                    </div>
                    <div>
                      <PhoneInput
                  ...
                  {formError && (
                    <div role="alert" aria-live="polite" className="bg-red-500/10 border border-red-500/20 text-red-500 text-[11px] font-bold p-3 rounded-xl font-mono">
                      {formError}
                    </div>
                  )}
